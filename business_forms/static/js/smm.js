    ...
    $('.submit_button').click(function (e) {
        ...
        $.each(formData, function (i, field) {
            if (field.name === 'social_networks') {
                social_networks.push(field.value)
                return
            }
            if (field.name === 'your_experience') {
                your_experience.push(field.value)
                return
            }
        ...
        formDataObj['social_networks'] = JSON.stringify(social_networks);
        formDataObj['your_experience'] = JSON.stringify(your_experience);
